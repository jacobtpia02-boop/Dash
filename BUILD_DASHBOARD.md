...
A single `<h1 class="dash-title">Jaykee's Dashboard</h1>` at the very top of the body. Styled as:
...
- The page opens with a gradient `Jaykee's Dashboard` headline at the top.
